...
export default function StartAttempt() {
	const [questions, setQuestions] = useState<Array<QuestionType>>(quizQuestions);
	...
	console.log("question verdit attempt : ", questionAttemptVerdictArray);

	const result = questionAttemptVerdictArray.reduce(
		(acc: number, element) =>
